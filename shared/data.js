...
const soundSlides = [
    {title:"Múa Lân Sư Rồng",festival:"TẾT NGUYÊN ĐÁN & TRUNG THU",question:"Âm thanh này là linh hồn của những dịp lễ tết lớn nào trong năm?",supportingContent:"Hoạt động đặc trưng: Múa Lân Sư Rồng.",intro:"Tiếng trống dồn dập hòa cùng tiếng của xã đồng là linh hồn của nghệ thuật Múa Lân Sư Rồng. Trong văn hóa Á Đông, tiếng trống này được tin là có năng lượng dương mạnh mẽ, giúp đánh thức các thần thú (Lân, Rồng) dậy để xua đuổi tà khí và \"gõ cửa\" những điều may mắn đầu năm.",meaning:["Tâm linh: Tiếng trống là cầu nối xua đuổi điềm gở (Niên), đón chào thần tài.","Văn hóa: Biểu tượng của sự thịnh vượng, hanh thông (\"Đầu xuôi đuôi lọt\").","Cộng đồng: Gắn kết mọi người trong niềm hân hoan chung của dịp Tết."],discovery:"Múa Lân thường có ông Địa đi cùng, tay cầm quạt phe phẩy, mang mặt nạ cười, tượng trưng cho sự may mắn, niềm vui và khả năng hóa giải điều dữ thành lành.",emoji:"🦁",color:"bg-festive-red",audio:"drum"},
